...
export default function RegisterPage() {
  ...
  const { register, error, clearError, isGuest, isAuthenticated } = useAuthStore();
    ...
    <div className="container mx-auto px-6 py-20 min-h-[70vh] flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <h1 className="text-3xl font-display font-bold text-on-surface mb-2 tracking-tight">Create Account</h1>
            <p className="text-on-surface-variant text-sm">Join the Accessomart elite</p>
          </div>
